...
public class DBConnector {
    ...
    private Player loadPlayer(int p_id) {
        try {
            ...
            //Gson configs
            Gson gson = new Gson();
            Type cardToken = new TypeToken<ArrayList<Card>>() {
            }.getType();
            Type luckToken = new TypeToken<ArrayList<LuckCard>>() {
            }.getType();
    ...
    private Table loadTable(int r_id) {
        try {
            ...
            //Gson configs
            Gson gson = new Gson();
            Type cardToken = new TypeToken<Stack<Card>>() {
            }.getType();
            Type luckToken = new TypeToken<Stack<LuckCard>>() {
            }.getType();
